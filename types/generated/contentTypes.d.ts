...
export interface ApiLevelLevel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    Tricks: Schema.Attribute.Relation<'oneToMany', 'api::trick.trick'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTrickTrick extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trick.trick'>;
    Progression: Schema.Attribute.Relation<'oneToMany', 'api::trick.trick'>;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    Trick_media: Schema.Attribute.Media<'images' | 'videos', true>;
